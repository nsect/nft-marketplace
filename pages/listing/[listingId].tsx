...
import { ListingType, NATIVE_TOKENS, ChainId, Marketplace } from '@thirdweb-dev/sdk';
  ...
  const createBidOrOffer = async () => {
    try {
      ...
      if (listing?.type === ListingType.Direct) {
        ...
        console.log('Buyout price not met, creating offer...');
    ...
    <div>
      ...
      <main className="max-w-6xl mx-auto p-2 flex flex-col lg:flex-row space-y-10 space-x-5 pr-10">
        ...
        <section className="flex-1 space-y-5 pb-20 lg:pb-0">
                  ...
                  <div>
                    <p
                      ...
                      key={
                        offer.listingId +
                        offer.offeror +
                        offer.totalDifferAmount.toString()
                      }
                    >
          ...
          <div className="grid grid-cols-2 space-y-2 itemscenter justify-end">
